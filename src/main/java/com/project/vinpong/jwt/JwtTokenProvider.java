...
public class JwtTokenProvider {
    ...
    public JwtTokenProvider(@Value("${jwt.secret}") String secretKey, @Value("${jwt.token-validity-in-seconds}") int expired) {
    ...
    public JwtToken generateToken(Authentication authentication) {
        ...
        Date accessTokenExpiresln = new Date(now + EXPIRED);
